          ...
          <>
            ...
            <View style={styles.button}>
              <View style={styles.width}>
                <SecondaryButton title='Next' MV={10} onPressFunc={fadeInWelcomeContent2} />
              </View>
            </View>
          </>}

        {content === 2 && <Animated.View style={{ opacity: fadeAnim1 }}>
          <WelcomeContent
          ...
          <View style={styles.button}>
            <View style={styles.width}>
              <SecondaryButton title='Next' MV={10} onPressFunc={fadeInWelcomeContent3} />
            </View>
          </View>
        </Animated.View>}

        {content === 3 && <Animated.View style={{ opacity: fadeAnim2 }}>
          <WelcomeContent
          ...
          <View style={styles.flex}>
            <View style={{ width: "40%" }}>
              <Button title='Login' MV={10} onPressFunc={() => { navigation.navigate('Login') }} />
            </View>
            <View style={{ width: "40%" }}>
              <SecondaryButton title='Register' MV={10} onPressFunc={() => { navigation.navigate('SignUp') }} />
            </View>
          </View>
        </Animated.View>}
