...
const Permission = () => {
    ...
    return (
        <View style={styles.Container}>
            <TouchableOpacity style={styles.button} onPress={() => askPermission("Contact")}>
                <Text style={styles.buttonText}>Contact</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.button} onPress={() => askPermission("Media")} >
                <Text style={styles.buttonText}>Media</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.button} onPress={() => askPermission("Camera")}>
