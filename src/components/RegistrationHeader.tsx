...
const RegistrationHeader = ({ title, content, imgSrc, showContent, navigation }: header) => {
    const navigationHook = useNavigation<NativeStackNavigationProp<AuthStackParamList>>();
    return (
        <>
            <StatusBar
            ...
            <View style={styles.header}>
                <View style={styles.rowAlign}>
                    ...
                    {navigation && <TouchableOpacity onPress={() => navigationHook.navigate('PartnerPreferance')}>
                        <Text style={styles.navigation}>Skip</Text>
                    </TouchableOpacity>}
                </View>
                {showContent && <View style={styles.row}>
